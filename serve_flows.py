...
from prefect_backend import run_shell, multi_file_upload, session_upload, upload_dataset, multi_assignment_upload, flat_multi_upload, parent_child_upload
...
if __name__ == "__main__":
    ...
    serve(multi_deploy, session_deploy, upload_deploy, ma_deploy, flat_multi_deploy, parent_child_deploy, limit=10)
