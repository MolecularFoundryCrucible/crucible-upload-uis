...
from prefect_backend import multi_file_upload, session_upload, upload_dataset, multi_assignment_upload, flat_multi_upload, parent_child_upload, photobox_upload, push_preview_file, review_upload
...
if __name__ == "__main__":
    ...
    preview_deploy = push_preview_file.to_deployment(name="push-preview-file")
    review_deploy = review_upload.to_deployment(name="review-upload")
    serve(multi_deploy, session_deploy, upload_deploy, ma_deploy, flat_multi_deploy, parent_child_deploy, photobox_deploy, preview_deploy, review_deploy, limit=10)
